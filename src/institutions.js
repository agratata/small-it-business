...
/**
 * Matching a person to their institution by email domain.
 *
 * Someone signing up with agrata@student.swinburne.edu.au should end up
 * attached to the Swinburne row, even though the seeded domain is just
 * swinburne.edu.au. So we try the full domain first, then walk up one
 * label at a time, and take the most specific match we find.
 */
